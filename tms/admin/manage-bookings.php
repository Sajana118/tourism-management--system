...
<link href="../assets/css/pages/admin-manage-bookings.css" rel="stylesheet">
</head>
<body>
<!-- Sidebar -->
<aside class="sidebar">
...
<main class="main-content">
    ...
    <div class="topbar">
        <div class="topbar-left">
            <h5><i class="fas fa-calendar-check me-2"></i>Manage Bookings</h5>
        </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h5><i class="fas fa-calendar-check me-2"></i>Booking Records</h5>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if($result->PaymentStatus=='completed') {
                                    echo '<span class="status-badge status-confirmed">Paid</span>';
                                    ...
                                    echo '<span class="status-badge status-pending">Not Paid</span>';
                                }
                                ?>
                            </td>
                            <td>
                                ...
                                <?php } else { ?>
                                    <a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')" class="btn btn-danger btn-sm">
                                        <i class="fas fa-times me-1"></i>Cancel
                                    </a>
                                    <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Booking has been confirmed')" class="btn btn-success btn-sm">
